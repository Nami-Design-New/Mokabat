            ...
            <div className="row justify-content-between">
              ...
              <div className="col-lg-6 col-12 p-2">
                <div className="sercvice_content">
                  <h2>Lab</h2>
                  <p>
                    In today's hyper "everything" business environment, the norm
                    is to ingest, aggregate, and push "insights &amp; practices"
                    to clients and ecosystems. We consistently explore, design,
                    articulate, and lead with pivotal insights as well as devise
                    future solutions.
                  </p>
                  <p>
                    We have an active in-house think tank enacting as a "thought
                    leader" derived from decades of "corporate innovation"
            ...
            <div className="row justify-content-between">
              ...
              <div className="col-lg-6 col-12 p-2">
                <div className="sercvice_content">
                  <h2>Studio</h2>
                  <p>
                    Once you are all set within our D. Lab, we start focusing on
                    where you need to take your business next. Our architects,
                    developers, and designers, with deep financial services
                    industry and cloud expertise, embed with your team to
                    understand your current environments and unique challenges
                    and goals.&nbsp;
                  </p>
                  <p>
                    We bring fresh perspectives and proven practices to
                    accelerate innovation and speed-to-value while your teams
                    learn through co-creation. As part of what we do, we support
                    you in defining your requirements, designing your UX/UI,
                    prototyping, and building your market strategy.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-6 col-12 p-2">
                <div className="sercvice_content">
                  ...
                  <p>
                    ...
                    green field for you by providing fast-track solutions.&nbsp;
                  </p>
                  <ul>
                    <li>
                      Develop standard restful API services such as Open Banking
                      and Open API services.
                    </li>
                    <li>
                      We are much ahead of implementing BaaS which plays a vital
                      role to support FinTech needs such as E-wallet as a
                      service and B2B as a service.
                    </li>
                    <li>
                      ...
                      security module, managed services, and Recon &amp; settle.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col-lg-6 col-12 p-2">
                <div className="sercvice_content">
                  ...
                  <p>
                    ...
                    prospects, competitors, and market dynamics. We oversee the
                    communications, PR, and marketing strategy, identifying
                    partnership opportunities and outreach, and building the
                    company's reputation internally and externally.
                  </p>
                </div>
              </div>
            </div>
